...
|---|---|---|---|---|---|
| `Rawls` | `01a0ad34-4083-7722-9977-1453ab75316b` | R26 | `be-leg2` | 运行中，已落 `docker-compose.yml`+17/−1、`app/common/model_capabilities.py`+283/−2；**守卫测试尚未落盘** | 10:50:08 |
...
| `Pasteur` | `01a0ad47-b96b-7b40-ae7f-5a1afc91f237` | R53 | `be-r53`（新建，基线 `1a46c6d`） | 运行中 | 10:53:16 树干净 |
